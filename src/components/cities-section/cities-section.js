...
const CitiesSection = () => {
  ...
  return (
    <section className={`ec-container ${styles.cities}`}>
      <img className={`small-widget ${styles.widget__timesYellow}`} src={timesYellowWidget} />
      ...
      <img className={`small-widget ${styles.widget__bracket}`} src={bracketsWidget} />
      <img className={`small-widget ${styles.widget__timesPurple}`} src={timesPurpleWidget} />
    </section>
  );
};
